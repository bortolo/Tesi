...
This approach is the natrual extension of \referenzaeq{eq: scharfetter gummel 1D electron}, indeed if we consider $d=1$ and resolve the integrals we obatin \textcolor{red}{aggiungere i passaggi per dimostrare l'equivalenza con il caso 1D}.
